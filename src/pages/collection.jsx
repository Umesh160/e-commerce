...
<p onClick={()=>setShowFilter(!showFilter)}  className='my-2 text-xl flex items-center cursor-pointer gap-2'> FILTERS
  <div className={` flex mb-1 ml-1 h-3 sm:hidden ${showFilter ? 'rotate-90' : ''}`}>
...
<div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
  <p className='flex gap-2'>
    <input  className='w-3' type="checkbox" value={'Topper'}  onChange={toogleSubCategory}/>Topwear
  </p>
  <p className='flex gap-2'>
    <input  className='w-3' type="checkbox" value={'Buttom'} onChange={toogleSubCategory} />Bottomwear
  </p>
  <p className='flex gap-2'>
